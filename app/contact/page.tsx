      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 md:py-28 relative z-10">
        ...
        <div className="grid md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-7 space-y-4">
           ...
           {/* 4. ig CARD */}
<div className="group relative bg-white/80 border border-slate-200/60 rounded-2xl p-4 shadow-xl shadow-slate-100/40 backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:border-pink-200 hover:shadow-2xl hover:shadow-pink-100/40 flex items-center justify-between">
  <div className="flex items-center gap-4 min-w-0">
    <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-yellow-50 via-pink-50 to-purple-50 flex items-center justify-center shrink-0 p-3 group-hover:scale-105 transition-transform duration-300">
    ...
    <div className="min-w-0">
      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">instagram</p>
      <a href="https://www.instagram.com/maxtechelectric/" target="_blank" rel="noopener noreferrer" className="text-base font-bold text-slate-900 mt-0.5 block hover:text-pink-600 transition-colors truncate">
        MaxTech Electric
      </a>
    </div>
  </div>
  <a href="https://www.instagram.com/maxtechelectric/" target="_blank" rel="noopener noreferrer" className="text-[11px] font-bold text-pink-700 bg-pink-50 border border-pink-100/60 px-3 py-1.5 rounded-full flex items-center gap-1 shadow-xs hover:bg-pink-100 transition-colors shrink-0 ml-2">
    เปิดเพจ <ArrowUpRight size={12} />
  </a>
</div>
